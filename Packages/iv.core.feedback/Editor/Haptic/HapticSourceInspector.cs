...
namespace Lofelt.NiceVibrations
{
    ...
    // Provides an inspector to link a HapticSource to a HapticClip.
    public class HapticSourceInspector : Editor
    {
        ...
        private static GUIContent hapticClipLabel = EditorGUIUtility.TrTextContent("Haptic Clip", "The HapticClip asset played by the HapticSource.");
        private static GUIContent fallbackPresetLabel = EditorGUIUtility.TrTextContent("Haptic Preset fallback", "Set the haptic preset to play in case the device doesn't support playback of haptic clips");
        private static GUIContent loopLabel = EditorGUIUtility.TrTextContent("Loop", "Set the haptic source to loop playback of the haptic clip");
