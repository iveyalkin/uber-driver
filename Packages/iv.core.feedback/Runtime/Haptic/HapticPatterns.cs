...
namespace Lofelt.NiceVibrations
{
    ...
    public static class HapticPatterns
    {
        ...
        private static float[] constantPatternTime = new float[] { 0.0f, 0.0f };
        ...
        struct Pattern
        {
            ...
            public String ToClip()
            {
                ...
                return TextAssets.patternTemplate.Replace("{amplitude-envelope}", amplitudeEnvelope);
            }
        }
        ...
        public static void PlayEmphasis(float amplitude, float frequency)
        {
            ...
            if (HapticController.Init() || GamepadRumbler.IsConnected())
            {
                ...
                String json = TextAssets.emphasisTemplate
        ...
        public static void PlayConstant(float amplitude, float frequency, float duration)
        {
            ...
            String json = TextAssets.constantTemplate
    ...
    internal static class TextAssets
    {
        public const string emphasisTemplate = @"{
    ""version"": {
        ""major"": 1,
        ""minor"": 0,
        ""patch"": 0
    ...
    ""signals"": {
        ...
        public const string patternTemplate = @"{
    ""version"": {
        ""major"": 1,
        ""minor"": 0,
        ""patch"": 0
    ...
    ""signals"": {
        ...
        public const string constantTemplate = @"{
    ""version"": {
        ""major"": 1,
        ""minor"": 0,
        ""patch"": 0
